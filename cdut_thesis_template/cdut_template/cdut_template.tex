...
\begin{document}
%----- 封面 -----%
\include{data/cover}   %-- 导入封面

%----- 摘要 -----%
\setcounter{page}{1}   %-- 设置起始页脚
\pagenumbering{Roman}  %-- 设置页码为大写罗马数字

\input{data/abstract_chinese.tex}  %-- 中文摘要
% \input{data/abstract_english.tex}  %-- 英文摘要
...
%----------------------------------------------正文----------------------------------------------%
%--------------------------------------结论、致谢、参考文献---------------------------------------%
\include{data/conclusion.tex} % 结论
